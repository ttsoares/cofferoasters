...
export default function HowItWorks() {
  ...
  return (
    <View className="mx-1 g:w-[90%] mt-[5rem] md:mt-[8rem] lg:mt-[8rem] rounded-lg">
      <ImageBackground
        source={bgSteps}
        resizeMode="cover"
        style={{
      ...
      >
        <View className="relative flex-col gap-6 md:flex-row md:mx-5 md:my-10 lg:items-start lg:mx-20 lg:my-28">
          ...
          <View className="hidden md:block absolute top-3 left-3 md:right-[29.5%] lg:right-[31%] h-[2px] bg-orange-200 z-[-1]" />
          {/* Step 01 */}
          <View className="flex-1 items-center md:items-start space-y-8">
            ...
            <MyText className="text-size16 font-barlowR text-white text-center  md:text-left px-5 md:pr-10 lg:pr-20">
